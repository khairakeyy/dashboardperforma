...
$query = "SELECT * FROM usaha_diaspora ORDER BY tanggal_input DESC";
    ...
    <style>
        ...
        @media print {
            ...
            .data-table th {
                ...
                /* Properti dengan awalan */
                print-color-adjust: exact;
                /* Tambahkan properti standar ini */
            }
        }
    </style>
</head>
        ...
        <main class="main">
            ...
            <div class="content">
                <div class="laporan-header">
                    <h1>Laporan Data Usaha Diaspora</h1>
                    <p>Periode: Hingga <?php echo date('d-m-Y'); ?></p>
                </div>
